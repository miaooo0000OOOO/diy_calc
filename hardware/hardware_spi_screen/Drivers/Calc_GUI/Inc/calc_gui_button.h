...
#ifndef __CALC_GUI_BUTTON_H__
#define __CALC_GUI_BUTTON_H__
...
#define KEYBROAD_LEFT 0
#define KEYBROAD_TOP (2 * 48)

#define BUTTON_POS(x, y) (KEYBROAD_LEFT + x * BUTTON_W), (KEYBROAD_TOP + y * BUTTON_H)
